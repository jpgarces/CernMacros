...
void ditau_Rapidity_lep_nonu(){
  ...
  TFile *outf = new TFile("ditau_Rapidity_lep_nonu.root","RECREATE");

  TH1F *hist_ditau_eep_Rapidity_nonu = new TH1F("hist_ditau_eep_Rapidity_nonu","di-Tau Rapidity from electron/positron decays",80,-10.0,10.0);
  TH1F *hist_ditau_emup_Rapidity_nonu = new TH1F("hist_ditau_emup_Rapidity_nonu","di-Tau Rapidity from electron/positive-muon decays",80,-10.0,10.0);
  TH1F *hist_ditau_muep_Rapidity_nonu = new TH1F("hist_ditau_muep_Rapidity_nonu","di-Tau Rapidity from muon/positron decays",80,-10.0,10.0);
  TH1F *hist_ditau_mumup_Rapidity_nonu = new TH1F("hist_ditau_mumup_Rapidity_nonu","di-Tau Rapidity from muon/positive-muon decays",80,-10.0,10.0);

  int e_count, anue_count, nut_count, n, nue_count, ep_count,anut_count, mu_count, anumu_count, numu_count, mup_count;

  Double_t rapidity, e, pz;
    
  Double_t daughter_e[10], daughter_pz[10];
