...
void bran_ratio_k(){
  ...
  //for(int entry = 29000; entry < 30000; ++entry){
    ...
    int n_ch_k_nt=0;
    for(int l = 0; l<10; ++l){
      if (daughter_pids_n[l]==-321 || daughter_pids_n[l]==321) n_ch_k_nt+=1;
      if (daughter_pids_n[l]==111) n_pi0_n+=1;
      //if (daughter_pids_n[l]!=-321&&daughter_pids_n[l]!=321&&daughter_pids_n[l]!=111&&daughter_pids_n[l]!=22&&daughter_pids_n[l]!=21&&daughter_pids_n[l]!=11&&daughter_pids_n[l]!=-11&&daughter_pids_n[l]!=12&&daughter_pids_n[l]!=-12&&daughter_pids_n[l]!=13&&daughter_pids_n[l]!=-13&&daughter_pids_n[l]!=14&&daughter_pids_n[l]!=-14&&daughter_pids_n[l]!=16&&daughter_pids_n[l]!=-16&&daughter_pids_n[l]!=0){
    ...
    //}
    if (n_ch_k_nt==1&&n_pi0_n<=3&&n==(n_ch_k_nt+n_pi0_n+1)) ch_k_1_n+=1;
    if (n_ch_k_nt==3&&n_pi0_n<=3&&n==(n_ch_k_nt+n_pi0_n+1)) ch_k_3_n+=1;
    ...
    if (n_ch_k_pt==1&&n_pi0_p<=3&&n==(n_ch_k_pt+n_pi0_p+1)) ch_k_1_p+=1;
    if (n_ch_k_pt==3&&n_pi0_p<=3&&n==(n_ch_k_pt+n_pi0_p+1)) ch_k_3_p+=1;
   }
  cout << "Number of tau decays into 1 negative kaon and up to 3 neutral pions: " << ch_k_1_n << " -> " << ch_k_1_n*100/200000.0 << "%" <<  endl;
  cout << "Number of tau decays into 2 negative kaons, 1 positive kaon and up to 3 neutral pions: " << ch_k_3_n << " -> " << ch_k_3_n*100/200000.0 << "%" << endl;
  cout << "Number of tau decays into 1 positive kaon and up to 3 neutral pions: " << ch_k_1_p << " -> " << ch_k_1_p*100/200000.0 << "%" << endl;
  cout << "Number of tau decays into 2 positive kaons, 1 negative kaon and up to 3 neutral pions: " << ch_k_3_p << " -> " << ch_k_3_p*100/200000.0 << "%" << endl;
