...
void ditau_PT_lep(){
  ...
  TFile *outf = new TFile("ditau_PT_lep.root","RECREATE");

  TH1F *hist_ditau_eep_PT = new TH1F("hist_ditau_eep_PT","di-Tau PT from electron/positron decays",100,0.0,60.0);
  TH1F *hist_ditau_emup_PT = new TH1F("hist_ditau_emup_PT","di-Tau PT from electron/positive-muon decays",100,0.0,60.0);
  TH1F *hist_ditau_muep_PT = new TH1F("hist_ditau_muep_PT","di-Tau PT from muon/positron decays",100,0.0,60.0);
  TH1F *hist_ditau_mumup_PT = new TH1F("hist_ditau_mumup_PT","di-Tau PT from muon/positive-muon decays",100,0.0,60.0);
