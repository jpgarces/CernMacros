...
void tau_energy_pions_3ch(){
  ...
  TFile *outf = new TFile("tau_energy_pions_3ch.root","RECREATE");

  TH1F *hist_tau_energy_3ch = new TH1F("hist_tau_energy_3ch","Tau energy",150,0.0,100.0);
  TH1F *hist_tau_energy_3ch10 = new TH1F("hist_tau_energy_3ch10","Tau energy",150,0.0,100.0);
  TH1F *hist_tau_energy_3ch20 = new TH1F("hist_tau_energy_3ch20","Tau energy",150,0.0,100.0);

  TH1F *hist_nut_energy_3ch = new TH1F("hist_nut_energy_3ch","Tau neutrino energy",150,0.0,100.0);
  TH1F *hist_nut_energy_3ch10 = new TH1F("hist_nut_energy_3ch10","Tau neutrino energy",150,0.0,100.0);
  TH1F *hist_nut_energy_3ch20 = new TH1F("hist_nut_energy_3ch20","Tau neutrino energy",150,0.0,100.0);
  
  TH1F *hist_ph_energy_3ch10 = new TH1F("hist_ph_energy_3ch10","Photon energy",150,0.0,100.0);
  TH1F *hist_ph_energy_3ch20 = new TH1F("hist_ph_energy_3ch20","Photon energy",150,0.0,100.0);

  TH1F *hist_pim_energy_3ch = new TH1F("hist_pim_energy_3ch","Negative pion energy",150,0.0,100.0);
  TH1F *hist_pim_energy_3ch10 = new TH1F("hist_pim_energy_3ch10","Negative pion energy",150,0.0,100.0);
  TH1F *hist_pim_energy_3ch20 = new TH1F("hist_pim_energy_3ch20","Negative pion energy",150,0.0,100.0);

  TH1F *hist_pip_energy_3ch = new TH1F("hist_pip_energy_3ch","Positive pion energy",150,0.0,100.0);
  TH1F *hist_pip_energy_3ch10 = new TH1F("hist_pip_energy_3ch10","Positive pion energy",150,0.0,100.0);
  TH1F *hist_pip_energy_3ch20 = new TH1F("hist_pip_energy_3ch20","Positive pion energy",150,0.0,100.0);
