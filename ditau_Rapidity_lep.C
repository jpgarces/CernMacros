...
void ditau_Rapidity_lep(){
  ...
  TFile *outf = new TFile("ditau_Rapidity_lep.root","RECREATE");

  TH1F *hist_ditau_eep_Rapidity = new TH1F("hist_ditau_eep_Rapidity","di-Tau Rapidity from electron/positron decays",80,-10.0,10.0);
  TH1F *hist_ditau_emup_Rapidity = new TH1F("hist_ditau_emup_Rapidity","di-Tau Rapidity from electron/positive-muon decays",80,-10.0,10.0);
  TH1F *hist_ditau_muep_Rapidity = new TH1F("hist_ditau_muep_Rapidity","di-Tau Rapidity from muon/positron decays",80,-10.0,10.0);
  TH1F *hist_ditau_mumup_Rapidity = new TH1F("hist_ditau_mumup_Rapidity","di-Tau Rapidity from muon/positive-muon decays",80,-10.0,10.0);
