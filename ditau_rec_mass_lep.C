...
void ditau_rec_mass_lep(){
  ...
  TFile *outf = new TFile("ditau_mass_lep.root","RECREATE");

  TH1F *hist_ditau_eep_mass = new TH1F("hist_ditau_eep_mass","di-Tau mass from electron/positron decays",100,0.0,40.0);
  TH1F *hist_ditau_emup_mass = new TH1F("hist_ditau_emup_mass","di-Tau mass from electron/positive-muon decays",100,0.0,40.0);
  TH1F *hist_ditau_muep_mass = new TH1F("hist_ditau_muep_mass","di-Tau mass from muon/positron decays",100,0.0,40.0);
  TH1F *hist_ditau_mumup_mass = new TH1F("hist_ditau_mumup_mass","di-Tau mass from muon/positive-muon decays",100,0.0,40.0);
