...
void tau_angles_pions_1ch(){
  ...
  TH1F *hist_nut_angles_1ch20 = new TH1F("hist_nut_angles_1ch20","Tau neutrino angles",150,0.0,180.0);
  
  TH1F *hist_ph_angles_1ch10 = new TH1F("hist_ph_angles_1ch10","Photon angles",150,0.0,180.0);
  TH1F *hist_ph_angles_1ch20 = new TH1F("hist_ph_angles_1ch20","Photon angles",150,0.0,180.0);

  TH1F *hist_pim_angles_1ch = new TH1F("hist_pim_angles_1ch","Negative pion angles",150,0.0,180.0);
  TH1F *hist_pim_angles_1ch10 = new TH1F("hist_pim_angles_1ch10","Negative pion angles",150,0.0,180.0);
  TH1F *hist_pim_angles_1ch20 = new TH1F("hist_pim_angles_1ch20","Negative pion angles",150,0.0,180.0);

  TVector3 pim_pvec, pi0_pvec, ph_pvec, nut_pvec;
   ...
   n=0;
    for (int i=tau_n->D1; i<= tau_n->D2; ++i){
	 ...
	 if (daughter->PID==-211&&daughter->Status==1){
	   pim_count+=1;
	   pim_pvec.SetX(daughter->Px);
	   pim_pvec.SetY(daughter->Py);
	   pim_pvec.SetZ(daughter->Pz);
         }
	 if (daughter->PID==111){
	    pi0_count+=1;
     ...
     if (pim_count==1&&pi0_count==0&&ph_count==0&&nut_count==1){
        hist_pim_angles_1ch->Fill(pim_pvec.Angle(taun_pvec)*57.2958);
	hist_nut_angles_1ch->Fill(nut_pvec.Angle(taun_pvec)*57.2958);
     }
     if (pim_count==1&&pi0_count==1&&ph_count==2&&nut_count==1){
        hist_pim_angles_1ch10->Fill(pim_pvec.Angle(taun_pvec)*57.2958);
	hist_nut_angles_1ch10->Fill(nut_pvec.Angle(taun_pvec)*57.2958);
	hist_ph_angles_1ch10->Fill(ph_pvec_arr[0].Angle(taun_pvec)*57.2958);
	hist_ph_angles_1ch10->Fill(ph_pvec_arr[1].Angle(taun_pvec)*57.2958);
     }
     if (pim_count==1&&pi0_count==2&&ph_count==4&&nut_count==1){
        hist_pim_angles_1ch20->Fill(pim_pvec.Angle(taun_pvec)*57.2958);
	hist_nut_angles_1ch20->Fill(nut_pvec.Angle(taun_pvec)*57.2958);
	hist_ph_angles_1ch20->Fill(ph_pvec_arr[0].Angle(taun_pvec)*57.2958);
	hist_ph_angles_1ch20->Fill(ph_pvec_arr[1].Angle(taun_pvec)*57.2958);
	hist_ph_angles_1ch20->Fill(ph_pvec_arr[2].Angle(taun_pvec)*57.2958);
	hist_ph_angles_1ch20->Fill(ph_pvec_arr[3].Angle(taun_pvec)*57.2958);
     }
  }
